...
export function InvoiceList({ documents }: { documents: Document[] }) {
  const [statusFilter, setStatusFilter] = useState("all")

  const filteredDocs = documents.filter((doc) => {
    if (statusFilter === "all") return true
    // For overdue filter, check effective status
      ...
      {filteredDocs.length === 0 ? (
        <div className="rounded-lg border bg-card p-6 text-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            {"\u0e2a\u0e23\u0e49\u0e32\u0e07\u0e43\u0e1a\u0e41\u0e08\u0e49\u0e07\u0e2b\u0e19\u0e35\u0e49\u0e41\u0e23\u0e01\u0e40\u0e1e\u0e37\u0e48\u0e2d\u0e40\u0e23\u0e34\u0e48\u0e21\u0e15\u0e34\u0e14\u0e15\u0e32\u0e21\u0e40\u0e2d\u0e01\u0e2a\u0e32\u0e23\u0e18\u0e38\u0e23\u0e01\u0e34\u0e08"}
          </p>
        </div>
      ) : (
