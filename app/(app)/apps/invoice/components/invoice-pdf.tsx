...
export function InvoicePDF({ data }: { data: InvoiceData }) {
  ...
  const thaiDueDate = formatThaiDateLong(dueDateObj)
      ...
      <Page size="A4" style={thaiPdfStyles.page}>
        ...
        <View style={styles.partySection}>
          <View style={styles.partyBox}>
            <Text style={styles.partyLabel}>{"\u0e1c\u0e39\u0e49\u0e2d\u0e2d\u0e01\u0e43\u0e1a\u0e41\u0e08\u0e49\u0e07\u0e2b\u0e19\u0e35\u0e49"} (Seller)</Text>
          ...
          <View style={styles.partyBox}>
            <Text style={styles.partyLabel}>{"\u0e1c\u0e39\u0e49\u0e23\u0e31\u0e1a\u0e43\u0e1a\u0e41\u0e08\u0e49\u0e07\u0e2b\u0e19\u0e35\u0e49"} (Buyer)</Text>
        ...
        {/* 8. Payment terms */}
        {paymentTerms && (
          <Text style={styles.paymentTermsNote}>
        ...
        <View style={styles.signatureArea}>
          <View style={styles.signatureBlock}>
            ...
            <Text style={styles.signatureLabel}>{"\u0e1c\u0e39\u0e49\u0e2d\u0e2d\u0e01\u0e43\u0e1a\u0e41\u0e08\u0e49\u0e07\u0e2b\u0e19\u0e35\u0e49"}</Text>
