  ...
  return (
    <Document>
      ...
      <Page size="A4" style={thaiPdfStyles.page}>
        {/* Title */}
        <Text style={thaiPdfStyles.title}>แบบ ภ.ง.ด.3</Text>
        <Text style={styles.subtitle}>
          แบบยื่นรายการภาษีเงินได้หัก ณ ที่จ่าย (สำหรับบุคคลธรรมดา)
        </Text>
      ...
      {transactions.length > 0 && (
        <Page size="A4" orientation="landscape" style={thaiPdfStyles.page}>
          <Text style={thaiPdfStyles.title}>ใบแนบ ภ.ง.ด.3</Text>
          <Text style={styles.subtitle}>
